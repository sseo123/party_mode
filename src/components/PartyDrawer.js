...
const coPilots = [
  {
    id: "1",
    name: "Ashley",
    image: require("../../assets/slide-one/p1.png"),
  },
  {
    id: "2",
    name: "Jordan",
    image: require("../../assets/slide-one/p2.png"),
  },
  {
    id: "3",
    name: "Michael",
    image: require("../../assets/slide-one/p3.png"),
  },
  {
    id: "4",
    name: "Taylor",
    image: require("../../assets/slide-one/p4.png"),
  },
  {
    id: "5",
    name: "Chris",
    image: require("../../assets/slide-one/p5.png"),
  },
  {
    id: "6",
    name: "Maya",
    image: require("../../assets/slide-one/p6.png"),
  },
];

export default function PartyDrawer({ visible, onClose, onStartParty }) {
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <View style={styles.drawer}>
            ...
            >
              <Text style={styles.mainTitle}>Party Mode 🪩</Text>
              ...
              {/* Party Timer section (Uncommented and cleanly rendered) */}
              ...
              >
                ...
                <View style={styles.optionTextContainer}>
                  <Text style={styles.optionTitle}>Set your Party Timer</Text>
              ...
              {/* Co-pilot selection */}
              <Text style={styles.sectionTitle}>Select a Co-Pilot</Text>
              ...
              <View style={styles.coPilotCard}>
                ...
                >
                  {coPilots.map((coPilot) => {
                    const isSelected = selectedCoPilot?.id === coPilot.id;
                    ...
                    return (
                      <Pressable
                        ...
                        style={[
                          ...
                          isSelected && styles.selectedCoPilotImageButton,
                        ]}
                        onPress={() => handleSelectCoPilot(coPilot)}
                      >
                        <Image
                ...
                <View style={styles.coPilotInformation}>
                  ...
                  <View style={styles.optionTextContainer}>
                    <Text style={styles.optionTitle}>Invite a co-pilot</Text>
              ...
              >
                <Text style={styles.partyButtonText}>Let’s Party!</Text>
              </Pressable>
      ...
      >
        <View style={styles.timerModalContainer}>
          ...
          <View style={styles.timerModalContent}>
            <Text style={styles.timerTitle}>Select Party Hours</Text>
